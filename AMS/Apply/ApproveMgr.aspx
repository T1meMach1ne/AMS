<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="ApproveMgr.aspx.cs" Inherits="Apply.ApproveMgr" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        ...
        function ApproveApply(ApplyID, ApplyTypeID, ApplyStatus) {
            if (ApplyStatus == 2) {
                $("#dlg1").dialog({ width: 630, height: 430 }).dialog("setTitle", "审批申请单").dialog("open");
                $("#Result").hide();
                $("#Describe").hide();
                $("#btnSubmit1").hide();
                $("#btnEsc1").val("关闭");
            }
            $("#dlg1").dialog({ width: 630, height: 530 }).dialog("setTitle", "审批申请单").dialog("open");
            $("#table1 :input").attr("readonly", true);
            $("#dllApproveResult").attr("readonly", false);
            $("#txtApproveDescribe").attr("readonly", false);
            $.ajax({
                type: "post",
            ...
            $("#btnSubmit1").click(function () {
                $.ajax({
                    ...
                    data: {
                        Method: "ApproveApply",
                        ID: ApplyID,
                        Status: $("#ContentPlaceHolder2_dllApproveResult").val(),
                        ApproveDescribe: $("#txtApproveDescribe").val()
                    },
                    success: function (data) {
                        if (data == "1") {
                            //表示添加成功
                            ...
                            //即时刷新列表上面的数据
                            BindApply();
                            $.messager.alert('温馨提示', '恭喜您，审批成功！', 'info');
                        }
                        else {
                            //表示添加失败
                            $.messager.alert('温馨提示', '对不起，审批失败！', 'info');
                        }
                    }
                });
            });
            ...
            <tr>
                ...
                <td>
                    <asp:RadioButtonList ID="rdoApplyStatus" runat="server" RepeatDirection="Horizontal">
                        ...
                        <asp:ListItem Text="已审批" Value="5"></asp:ListItem>
    ...
    <div id="dlg1" class="easyui-dialog" title="My Dialog" style="width: 400px; height: 300px;"
        ...
        <table align="center" id="table1">
            ...
            <tr id="Result">
                ...
                <td colspan="3">
                    <asp:DropDownList ID="dllApproveResult" runat="server">
                        <asp:ListItem Text="审批通过" Value="2"></asp:ListItem>
                        <asp:ListItem Text="审批否决" Value="-1"></asp:ListItem>
                    </asp:DropDownList>
                </td>
            </tr>
            <tr id="Describe">
                ...
                <td colspan="3">
                    <textarea id="txtApproveDescribe" rows="3" cols="100" style="width: 350px; height: 50px;
                        resize: none;"></textarea>
                </td>
            </tr>
