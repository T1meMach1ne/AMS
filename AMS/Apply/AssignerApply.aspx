<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="AssignerApply.aspx.cs" Inherits="Apply.AssignerApply" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        ...
        function ApproveApply(ApplyID, ApplyTypeID, ApplyStatus) {
            ...
            $("#ddlDealer").attr("readonly", false);
            $("#txtAssignerDescribe").attr("readonly", false);
            $.ajax({
                type: "post",
            ...
            $("#btnSubmit1").click(function () {
                ...
                $.ajax({
                    ...
                    url: "/Handlers/ApplyHandler.ashx",
                    data: {
                        Method: "AssignerApply",
                        ID: ApplyID,
                        Dealer: $("#ddlDealer").val(),
                        AssignerDescribe: $("#txtAssignerDescribe").val()
                    },
                    success: function (data) {
                        if (data == "1") {
                            //表示添加成功
            ...
            <tr>
                ...
                <td>
                    <asp:RadioButtonList ID="rdoApplyStatus" runat="server" RepeatDirection="Horizontal">
                        <asp:ListItem Text="待分配" Value="2" Selected="True"></asp:ListItem>
                        <asp:ListItem Text="已分配" Value="6"></asp:ListItem>
    ...
    <div id="dlg1" class="easyui-dialog" title="My Dialog" style="width: 400px; height: 300px;"
        ...
        <table align="center" id="table1">
            ...
            <tr id="Describe">
                ...
                <td colspan="3">
                    <textarea id="txtAssignerDescribe" rows="3" cols="100" style="width: 350px; height: 50px;
                        resize: none;"></textarea>
                </td>
            </tr>
